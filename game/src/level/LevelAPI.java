...
public class LevelAPI {
    ...
    /**
     * English: Load a new level with random size and the given desing
     *
     * @param designLabel The design that the level should have
     */
    /**
     * German: Laden eines neuen Levels mit zufälliger Größe und dem angegebenen Design
     *
    ...
    /**
     * English: Load a new level with the given size and a random desing
     *
     * @param size wanted size of the level
     */
    /**
     * German: Laden eines neuen Levels mit der angegebenen Größe und einem zufälligen Design
     *
