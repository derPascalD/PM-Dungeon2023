...
public class StaticRadiusWalk implements IIdleAI {
    ...
    /**
     * English: Finds a point in the radius and then moves there. When the point has been reached, a
     * new point in the radius is searched for from the center.
     *
     ...
     */
    /**
     * German: Findet einen Punkt im Radius und bewegt sich dann dorthin. Wenn der Punkt erreicht
     * ist, wird ein neuer Punkt im Radius vom Zentrum aus gesucht.
     *
     * @param radius Radius, in dem nach einem Zielpunkt gesucht werden soll
     * @param breakTimeInSeconds wie lange (in Sekunden) gewartet werden soll, bevor ein neues Ziel
     *     gesucht wird
     */
